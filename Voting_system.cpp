...
/************************************ by Prince Kumar *********************************/
//Email ID: kumar2prince1@gmail.com --> Prince

//Password="edit_it"

//****************************************************************************************
//				Headerfiles used in program                       
//****************************************************************************************
#include<iostream>
#include<fstream>
#include<process.h>
 ...
 for(;;)
{
 clrscr();
 gotoxy(16,20);
 cout<<"Enter the password to initialise the setup :";
 r=0;
 for(int i=0;;i++)
{
 ch=getch();
